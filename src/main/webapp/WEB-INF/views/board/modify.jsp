...
<head>
    ...
    <script>
        function modifyBoardContent() {
            let emptyFlag = new Boolean(true);
...
<main class="container p-3 mt-3">
    ...
    <form id="boardForm" class="row g-3" action="/board/modify" method="post">
        ...
        <div class="mb-3">
            <label for="ex02Title" class="form-label">제목</label>
            <input type="text" class="form-control" id="formTitle" name="title" placeholder="제목을 입력해주세요."
                   value='<c:out value="${board.title}"/>'>
        </div>
        <div class="mb-3">
            <label for="ex02Writer" class="form-label">작성자</label>
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="formContent" name="content" rows="3" placeholder="내용을 입력해주세요."><c:out
                    value="${board.content}"/></textarea>
        </div>
        <div class="col-12">
            <button type="button" class="btn btn-primary" onclick="modifyBoardContent();">
                수정
            </button>
